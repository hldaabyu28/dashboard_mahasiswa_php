...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5">Halaman Edit Mata kuliah</h1>
...
if (mysqli_num_rows($result) > 0) {
  while($row = mysqli_fetch_assoc($result)) {
    ...
    <form action="proses_edit_mata_kuliah.php" method="post">
...
<div class="form-group">
    ...
    <input name="matkul" value="<?php echo $row["matkul"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
 
  <div class="form-group">
    <label for="exampleInputEmail1">sks</label>
    <input name="sks" value="<?php echo $row["sks"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
