...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5">Halaman Edit Jurusan</h1>
...
if (mysqli_num_rows($result) > 0) {
  ...
  <input name="id" value="<?php echo $row["id"]; ?>" type="hidden">
    ...
    <input name="kode_jurusan" value="<?php echo $row["kode_jurusan"]; ?>" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
...
<div class="form-group">
    ...
    <input name="nama_jurusan" value="<?php echo $row["nama_jurusan"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
 
  <div class="form-group">
    <label for="exampleInputEmail1">Jenjang</label>
    <input name="jenjang" value="<?php echo $row["jenjang"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
 
  <div class="form-group">
    <label for="exampleInputEmail1">Jumlah Semester</label>
    <input name="jumlah_semester" value="<?php echo $row["jumlah_semester"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
