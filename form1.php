...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5">Halaman Input Data Tabel Dosen</h1>
 
   
    <form action="proses_dosen.php" method="post">
  <div class="form-group">
    <label for="exampleInputEmail1">NIP (Nomer Induk Pegawai) </label>
  ...
  <div class="form-group">
    ...
    <input name="kelamin" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
  ...
  <div class="form-group">
    ...
    <input name="telepon" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
