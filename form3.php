...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5">Halaman Input Data Tabel Jurusan </h1>
 
   
    <form action="proses_jurusan.php" method="post">
  <div class="form-group">
    <label for="exampleInputEmail1">Kode Jurusan </label>
    <input name="kode_jurusan" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Nama Jurusan</label>
    <input name="nama_jurusan" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
 
  <div class="form-group">
    <label for="exampleInputEmail1">Jenjang</label>
    <input name="jenjang" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
 
  <div class="form-group">
    <label for="exampleInputEmail1">Jumlah Semester</label>
    <input name="jumlah_semester" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
