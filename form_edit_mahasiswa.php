...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5">Halaman Edit Mahasiswa</h1>
...
if (mysqli_num_rows($result) > 0) {
  ...
  <input name="id" value="<?php echo $row["id"]; ?>" type="hidden">
    ...
    <input name="nim" value="<?php echo $row["nim"]; ?>" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input name="alamat" value="<?php echo $row["alamat"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
 
  <div class="form-group">
    <label for="exampleInputEmail1">Jenis Kelamin</label>
    <input name="jenis_kelamin" value="<?php echo $row["jenis_kelamin"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
 
  <div class="form-group">
    <label for="exampleInputEmail1">No Telepon</label>
    <input name="no_tlp" value="<?php echo $row["no_tlp"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
 
  <div class="form-group">
    <label for="exampleInputEmail1">Email</label>
    <input name="email" value="<?php echo $row["email"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
 
  <div class="form-group">
    <label for="exampleInputEmail1">Tempat</label>
    <input name="tempat" value="<?php echo $row["tempat"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
 
  <div class="form-group">
    <label for="exampleInputEmail1">Tanggal</label>
    <input name="tanggal" value="<?php echo $row["tanggal"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
