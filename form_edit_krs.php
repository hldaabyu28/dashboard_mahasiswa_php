...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5">Halaman Edit Krs</h1>
...
if (mysqli_num_rows($result) > 0) {
  while($row = mysqli_fetch_assoc($result)) {
    ...
    <form action="proses_edit_krs.php" method="post">
...
<div class="form-group">
    ...
    <input name="nip" value="<?php echo $row["nip"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
 
  <div class="form-group">
    <label for="exampleInputEmail1">Kode MK</label>
    <input name="kode_mk" value="<?php echo $row["kode_mk"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
 
  <div class="form-group">
    <label for="exampleInputEmail1">Absen</label>
    <input name="absen" value="<?php echo $row["absen"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
 
  <div class="form-group">
    <label for="exampleInputEmail1">Uts</label>
    <input name="uts" value="<?php echo $row["uas"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
 
  <div class="form-group">
    <label for="exampleInputEmail1">Uas</label>
    <input name="uas" value="<?php echo $row["uas"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
