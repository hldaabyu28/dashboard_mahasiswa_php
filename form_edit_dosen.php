...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input name="jeniskelamin" value="<?php echo $row["jeniskelamin"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
  ...
  <div class="form-group">
    ...
    <input name="notlp" value="<?php echo $row["notlp"]; ?>"" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  </div>
