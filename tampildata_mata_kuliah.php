...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5">Halaman Tampil Data Mata Kuliah</h1>
...
if (mysqli_num_rows($result) > 0) {
  while($row = mysqli_fetch_assoc($result)) {
    ...
    echo " <tr><td>" . $row["kode_mk"]. " </td><td> " . $row["matkul"]. "</td><td>" . $row["sks"]. "</td><td>
       <a href='proses_mata_kuliah_delete.php?id=". $row["id"]."' <button type='button' class='btn btn-danger'>Delete</button></a>
    </td> </tr>";
  }
} else {
  echo "0 results";
