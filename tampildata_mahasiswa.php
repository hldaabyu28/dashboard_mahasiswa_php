...
if (mysqli_num_rows($result) > 0) {
  while($row = mysqli_fetch_assoc($result)) {
    ...
    echo " <tr><td>" . $row["nim"]. " </td><td> " . $row["nama"]. "</td><td>" . $row["alamat"]. "</td><td>". $row["jenis_kelamin"]."</td><td>". $row["no_tlp"]."</td><td>". $row["email"]."</td><td>
    <a href='proses_mahasiswa_delete.php?id=". $row["id"]."' <button type='button' class='btn btn-danger'>Delete</button></a>
    </td> </tr>";
  }
} else {
  echo "0 results";
